...
const WordCloud = () => (
  <div className="wordcloud">
    ...
    <Link to={withPrefix('about#wordcloud')} href={withPrefix('about#wordcloud')} >
      <picture>
        <source className="lozad" srcSet="data:image/gif;base64,R0lGODlhAQABAGAAACH5BAEKAP8ALAAAAAABAAEAAAgEAP8FBAA7" data-srcset="https://raw.githubusercontent.com/tubone24/auto_tweet_wordcloud/master/word_cloud_blog.webp" type="image/webp" />
