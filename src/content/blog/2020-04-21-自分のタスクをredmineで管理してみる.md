...
description: "自宅サーバーにRedmineを導入して個人タスクを管理する方法を紹介します。おすすめプラグイン（Agile・Checklist・Work Time等）やGitLabとの連携設定など、個人開発でも活用できるRedmine運用のコツを解説します。"
tags:
  - タスク管理
  - Redmine
headerImage: /images/blog/Saix67W.png
...
![Redmineにminimalflat2テーマを適用したダッシュボード画面](/images/blog/Saix67W.png)

## プラグイン

![Redmineにインストール済みのプラグイン一覧画面](/images/blog/2VuQKXY.png)
...
同じサーバー内にレポジトリ管理サーバーとしてGitLabを入れていますのでそちらと連携させています。ボトルネック調査には[GoのEchoでJaegerを使う方法](/2019/1/3/go-jaeger/)なども活用しています。
