...
tags:
  - 機械学習
  - 物体検知
headerImage: '/images/blog/jzkNhR6.jpg'
...
![Jetson NanoにRaspberry Pi互換カメラモジュールを接続した様子](/images/blog/gWqd2xb.jpg)
...
![tiny_yolov2_onnx_camで物体を検知しバウンディングボックスが表示された画面](/images/blog/jzkNhR6.jpg)
