...
tags:
  - Elasticsearch
headerImage: /images/blog/1UvKYKu.gif
...
![AWS re:inventが開催されているラスベガスの風景](/images/blog/wuH4vwW.jpg)
...
![企業名を入力するとサジェスト候補がリアルタイムに表示されるUIのデモ](/images/blog/1UvKYKu.gif)
...
![Elasticsearchを使ったサジェスト機能のアーキテクチャ概要図](/images/blog/OO7JYK3.jpg)
...
![Material UIのAutocompleteコンポーネントによるサジェスト動作のデモ](/images/blog/1WX3Roe.gif)
...
![デバウンス300msでの企業名サジェスト動作デモ](/images/blog/TFdYdcS.gif)

**50ms**

![デバウンス50msでの企業名サジェスト動作デモ、より機敏に反応している](/images/blog/fQe66X3.gif)
...
![N-gramとEdge N-gramによる転置インデックスの分割イメージ図](/images/blog/qH1P0nD.jpg)
...
![ふりがなと企業名のマルチマッチング検索による重み付けの概念図](/images/blog/1HLTLQL.jpg)
...
![ECS Fargateに小さなElasticsearchコンテナを配置したインフラ構成図](/images/blog/ioPuQHy.jpg)
...
![Elasticsearchのアナライザー処理フロー：Character Filter → Tokenizer → Token Filterの順で処理される図](/images/blog/Nuvz5Ik.png)
