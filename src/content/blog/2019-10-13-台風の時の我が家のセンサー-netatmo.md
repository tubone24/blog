...
![netatmo-zabbixリポジトリのREADMEに表示されるZabbixダッシュボードの画面](https://i.imgur.com/iqO8wUH.png)
...
![Zabbixのメトリクス取得がタイムアウトしてデータが欠けているグラフ](https://i.imgur.com/8SfKOwD.png)
...
![NetatmoのCSVエクスポート機能の画面](https://i.imgur.com/KB59nsj.png)
...
![Netatmo Dashboardで表示した台風通過時の気圧・風向・風速の推移グラフ](https://i.imgur.com/eONLraE.png)
