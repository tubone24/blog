...
tags:
  ...
  - Resume
  - CV
headerImage: '/images/blog/eQ7uBsO.png'
...
![API With GitHubのレポジトリ作成画面](/images/blog/6Lti5I8.png)

あとは普通にレポジトリを新規作成する手順で作っていきます。

![API With GitHubでレポジトリを新規作成する手順画面](/images/blog/d4nmRXZ.png)

Make APIボタンを押すと・・・。

![API With GitHubのMake APIボタンを押した画面](/images/blog/W3Paou3.png)

新規JSONファイルを作る画面に進みます。

![API With GitHubの新規JSONファイル作成画面](/images/blog/vzhzqiI.png)

JSON ResumeのJSONは `resume.json`がデフォルトなので `resume.json`で作ります。

![API With GitHubでresume.jsonファイルを作成した画面](/images/blog/ay4H67M.png)
...
![API With GitHubでJSON Resume入力が完了した編集画面](/images/blog/PSokx4v.png)

LinkからAPIにアクセスしてみましょう!!!

![JSON ResumeのAPIレスポンスがブラウザに表示されている画面](/images/blog/wF82uti.png)
...
![resume-cliで生成したHTMLテンプレートのレジュメ表示画面](/images/blog/IIzgYrK.png)
