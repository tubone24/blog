...
- 脆弱性診断
- GitHub Actions
headerImage: /images/blog/FnGbBym.png
...
![Snykの脆弱性レポート画面で修正方法やリファレンスが表示されている様子](/images/blog/g5fWDjA.png)

Depandabotも書いてある情報は大差ないのですが、なんとなくSnykのほうが見やすい..。

![Dependabotの脆弱性アラート画面との比較](/images/blog/oGOC92Y.png)
...
![SnykダッシュボードでGitHubリポジトリ連携後に脆弱性が自動検出されている画面](/images/blog/he9u9kb.png)
...
![ブログ記事下部に表示されるTwitter・FacebookのShareBoxコンポーネント](/images/blog/w86sKvc.png)
...
![GitHub PRにSnykの脆弱性レポートがコメントとして自動投稿されるデモ](/images/blog/mUDXQfl.gif)
...
![OWASP ZAP Web GUIのスプラッシュ画面](/images/blog/7rIrR1o.png)
...
![OWASP ZAPのAutomated Scanでターゲット設定とStandardモードを選択する画面](/images/blog/rs9HIta.png)
...
![OWASP ZAPでAutomated ScanのSpider設定画面](/images/blog/Moc4POV.png)
...
![Ajax Spiderがサブツリーのエンドポイントを収集している進行画面](/images/blog/i0OIcxd.png)

Spiderが終わるとそのまま**Passive Scan、Active Scan**に入ります。検知されたURLの量にもよりますが30分から1時間くらいは平気でかかります。

![OWASP ZAPのPassive ScanとActive Scanが進行中のスキャン画面](/images/blog/kNtlibG.png)
...
![SQL InjectionやXSSなどの攻撃パターンが実行されているログ画面](/images/blog/wNJxvr0.png)
...
![技術ブログのコンテンツが原因で誤検知が発生したスキャン結果画面](/images/blog/YguJMkA.png)
...
![GitHub Pagesにデプロイされた OWASP ZAPの診断レポートHTML](/images/blog/FnGbBym.png)
...
![「今日も一日ご安全に」のイメージ画像](/images/blog/1vEoOf5.jpg)
