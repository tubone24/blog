...
tags:
  ...
  - Clickhouse
  - AWS
headerImage: /images/blog/P5XKwij.png
...
![EFSとEBSのコスト比較でEFSが約300%高いことを示す図](/images/blog/6Lm97QF.png)
...
![ClickHouseのS3 Diskを使ったアーキテクチャでEFSにはメタデータのみ保存する構成図](/images/blog/P5XKwij.png)
...
【Before】
![S3 Disk適用前のEFSストレージ使用量を示すグラフ](/images/blog/Qunuknu.png)

【After】
![S3 Disk適用後のEFSストレージ使用量がメタデータのみに削減されたグラフ](/images/blog/hA9LK7l.png)
...
[![clickhouse-server-s3diskのGitHub Container Registryページ](/images/blog/DoTRtn3.png)](https://github.com/tubone24/clickhouse-server-s3disk/pkgs/container/clickhouse-server-s3disk)
...
[![LangfuseのGitHub Discussionでコスト削減のアイディアが議論されているスレッド](/images/blog/YpqcLo2.png)](https://github.com/orgs/langfuse/discussions/5516)
