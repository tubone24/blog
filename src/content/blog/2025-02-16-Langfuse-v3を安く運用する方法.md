---
slug: 2025/02/16/cost-effective-langfuse-v3-deployment
title: "Langfuse v3を安く運用する方法"
date: 2025-02-16T09:18:19+0000
description: "Langfuse v3のインフラコストを削減する4つの方法を紹介。Fargate Spot・ARM64(Graviton)・ECS on EC2への切り替え・ClickHouseのS3 Disk運用でEFSコストを大幅削減する具体的な設定手順と効果を解説します"
tags:
  - Langfuse
  - Clickhouse
  - AWS
...
**Langfuse v3**にバージョンアップをしたことでLangfuseにかかるインフラコストが上がってませんか？[前回の記事でLangfuse v3をAWSマネージドサービスで構築する方法](/2024/12/30/building-langfuse-v3-with-aws-managed-services/)を紹介しましたが、構築したあとのコスト問題にも向き合う必要があります。
...
![EFSとEBSのコスト比較でEFSが約300%高いことを示す図](https://i.imgur.com/6Lm97QF.png)
...
![ClickHouseのS3 Diskを使ったアーキテクチャでEFSにはメタデータのみ保存する構成図](https://i.imgur.com/P5XKwij.png)
...
【Before】
![S3 Disk適用前のEFSストレージ使用量を示すグラフ](https://i.imgur.com/Qunuknuh.png)

【After】
![S3 Disk適用後のEFSストレージ使用量がメタデータのみに削減されたグラフ](https://i.imgur.com/hA9LK7lh.png)
...
[![clickhouse-server-s3diskのGitHub Container Registryページ](https://i.imgur.com/DoTRtn3m.png)](https://github.com/tubone24/clickhouse-server-s3disk/pkgs/container/clickhouse-server-s3disk)
...
[![LangfuseのGitHub Discussionでコスト削減のアイディアが議論されているスレッド](https://i.imgur.com/YpqcLo2m.png)](https://github.com/orgs/langfuse/discussions/5516)

改めて、Langfuseのコミュニティの力を感じることができました。ありがとうございました。[企業名サジェスト機能の貧乏開発](/2024/12/05/cost-effective-company-name-suggestion-feature/)でもFargate Spotを使ったコスト削減に取り組んでおり、小さなコンテナを使い倒す知見は本記事とも共通するものがあります。
