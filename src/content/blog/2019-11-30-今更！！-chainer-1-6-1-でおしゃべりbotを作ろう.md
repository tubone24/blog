...
description: "Chainer 1.6.1とLSTMを使って日本語おしゃべりBotを構築する手順を解説。対話コーパスの取得・分かち書き・chainer-char-rnnでの学習・Tornado APIサーバーの構築まで、Pythonで動くチャットボットを一通り作れる実践的なガイドです。"
tags:
  - Python
  - Chainer
  - RNN
  ...
  - アイマス
  - デレマス
headerImage: '/images/blog/DJL1fwu.png'
...
![Slack上の智絵里ちゃんBotとDocomoAPIの会話比較](/images/blog/DJL1fwu.png)
...
ChainerやPythonを使った機械学習に興味がある方は、[ひなこのーと×Deep LearningでCNNによるキャラクター分類に挑戦した記事](/2017/07/17/hinako-chainer/)や、[R言語でサポートベクターやニューラルネットを比較した記事](/2017/07/11/rlang/)もぜひご覧ください。
