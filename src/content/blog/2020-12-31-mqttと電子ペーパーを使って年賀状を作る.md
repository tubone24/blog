...
tags:
  ...
  - RaspberryPi
  - 年賀状
headerImage: /images/blog/tmkmoVA.png
...
![斎藤佑樹の「考えてもしょうがないBOX」記事のスクリーンショット](/images/blog/BU7o9ke.jpg)
...
![MQTT年賀状システムのアーキテクチャ図：フロント→FastAPI→MQTTブローカー→電子ペーパー](/images/blog/E3hyjnA.png)
...
![React博士のイラスト（質問を受けている）](/images/blog/zrdOCVi.png)

> 知らね。自分で考えろ

![React博士のイラスト（突き放す表情）](/images/blog/HnLNjda.png)
...
![年賀状作成フォーム：名前・タイトル・メッセージ・画像の入力欄](/images/blog/k4Ti9nI.png)

**名前**、**タイトル**、**メッセージ**と**画像**を入力フォームに入れていきます。Previewボタンを押すと相手に送信する年賀状の**プレビュー**ができます。

![年賀状のプレビュー画面：送信前に完成イメージを確認できる](/images/blog/lEjbh7L.png)

問題なければ、**Submit**します。

相手がTopicをSubscribeしていれば、このように電子ペーパーに年賀状が描画されます。

![電子ペーパーにMQTT経由で年賀状が描画されるデモ動画](/images/blog/LXEcbLD.gif)

## 改めまして

![完成した電子ペーパー年賀状の表示例](/images/blog/WJnsQlT.png)
