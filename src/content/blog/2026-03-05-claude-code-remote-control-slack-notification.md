...
tags:
  ...
  - AI
  - 自動化
headerImage: /images/blog/ctW1dE6.png
...
![Slackに承認待ちのClaude Codeセッション情報がBlock Kit形式で通知されている画面](/images/blog/ctW1dE6.png)

このような形でSlackに承認待ちのセッションの情報が飛んできます。

また、処理完了も同じように通知するようにしてます。これもこれで終わったことがわかるので便利です。

![Slackに処理完了の通知が表示されている画面](/images/blog/FeVnSu2.png)
...
![通勤電車内でスマートフォンからClaude Codeを操作するイメージ図](/images/blog/gGOLJkw.png)
