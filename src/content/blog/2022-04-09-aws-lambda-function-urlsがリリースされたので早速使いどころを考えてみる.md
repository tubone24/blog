...
tags:
  - AWS
  - Lambda
headerImage: /images/blog/alxzd7y.png
...
![Lambda関数作成画面で関数URLを有効化するチェックボックスを表示したAWSコンソール](/images/blog/tD6NepW.png)
...
![Lambda関数の概要画面に表示された関数URLのエンドポイント](/images/blog/Fe6zbrS.png)
...
![ブラウザからLambda Function URLにアクセスしてレスポンスが返ってきた画面](/images/blog/OaIFZxx.png)
...
![sleepパラメータを1000msに設定して1秒後にレスポンスが返ってきた結果](/images/blog/V6AQ1kl.png)

では、API Gatewayのタイムアウトの30秒に設定してみましょう。(Lambdaのタイムアウトは2分にしてます)

![sleepを30秒に設定してもタイムアウトせずレスポンスが返ってきた結果](/images/blog/Jh9cixG.png)

タイムアウトしませんでした!!ではLambdaのタイムアウトまで引き延ばしてみましょう！

![Lambdaのタイムアウト値を超えた場合にInternal Server Errorが返された結果](/images/blog/UCbN8Df.png)
