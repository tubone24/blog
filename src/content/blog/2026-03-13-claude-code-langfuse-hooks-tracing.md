...
![img](https://i.imgur.com/E6PElfJ.png)
...
![img](https://i.imgur.com/YESLGDQ.png)
...
![img](https://i.imgur.com/9nEH2qO.png)
...
![img](https://i.imgur.com/Cs5RQqv.png)
...
Claude Codeがどんなツールをどんな順序で呼んでいるか、サブエージェントにどんな指示を出してどんな結果を受け取っているか。それを眺めていると、自分のエージェント設計にも活かせるヒントがゴロゴロ転がっています。
