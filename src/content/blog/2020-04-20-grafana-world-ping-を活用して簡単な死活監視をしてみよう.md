...
![GrafanaでZabbixメトリックを表示したダッシュボード画面](https://i.imgur.com/N2pDM5D.png)
...
![Grafanaのプラグイン一覧画面でデータソースやパネルを追加する様子](https://i.imgur.com/4puZFgk.png)
...
![World PingのPlugin Config画面でGrafana.net APIキーを設定する画面](https://i.imgur.com/3jpOIzC.png)
...
![World Pingのエンドポイント追加画面でドメイン名と監視サービスを設定する様子](https://i.imgur.com/JVyAD6w.png)

このようにEndpointにドメイン名を設定し、監視したいサービスを選びConfigureを押します。

![World Pingの監視詳細設定画面で監視間隔やHTTPメソッドなどを設定する様子](https://i.imgur.com/XCXFfBk.png)
...
![World Ping Home画面で世界地図上にエンドポイントの死活監視結果が表示されたダッシュボード](https://i.imgur.com/iLyWtZb.png)
