...
tags:
  - 機械学習
  - StyleGAN
headerImage: /images/blog/VfRjfpW.png
...
![GANの仕組みを示すイラスト（GeneratorとDiscriminatorの対立構造）](/images/blog/SVZB0Wi.png)
...
![StyleGANで生成された実在しない女性のポートレート画像](/images/blog/9mP8aH2.jpg)
...
![Progressive Growingの概念図（低解像度から高解像度へ段階的に画像を生成するプロセス）](/images/blog/bTE91Hx.png)
...
![Style Transferの例（写真に絵画の画風を適用した結果）](/images/blog/9EAE63P.png)
...
![AdaINのアーキテクチャ図（コンテンツとスタイルの統計量を用いた正規化プロセス）](/images/blog/z7ZpFko.png)
...
![StyleGANのGenerator構造図（constテンソル入力とAdaINによるStyle適用の流れ）](/images/blog/7xOURgl.png)
...
![gwern.netへの感謝を込めた肩たたき券のイラスト](/images/blog/0IEMnPa.png)
...
![StyleGANで生成されたアニメ風キャラクター画像](/images/blog/ET5Bn63.png)
...
![StyleGAN2のgenerate_anime.pyを実行するコマンドプロンプト画面](/images/blog/k3KihLx.png)

### まだうまく動かない

エラーがでました..。

![fused_bias_act.cuのコンパイルエラーが表示されたコマンドプロンプト](/images/blog/0KH7SgH.png)
...
![TensorFlowのGitHub IssueでVisual C++ 2015が必要と回答されている画面](/images/blog/zXCnrTq.png)
...
![StyleGAN2のREADMEにVisual Studio 2017対応と書かれている部分](/images/blog/1KUffz4.png)
...
![Visual Studio 2015をインストール後にgenerate_anime.pyを再実行する画面](/images/blog/YE8Pdyb.png)
...
![resultsディレクトリに生成されたアニメ画像ファイルの一覧](/images/blog/daSYwz2.png)

ちゃんとresultsに画像が出力されてます！

![StyleGAN2で生成された高品質なアニメ風キャラクター画像](/images/blog/VfRjfpW.png)
