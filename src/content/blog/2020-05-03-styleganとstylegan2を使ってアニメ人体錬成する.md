...
description: "NVIDIAのStyleGANとStyleGAN2を使って512x512の高解像度アニメキャラ画像を生成する方法を解説します。GANの仕組みからProgressive Growing・AdaINの技術解説、Windows環境でのCUDA/MSVC環境構築のトラブルシューティングまで詳しく紹介します。"
tags:
  - 機械学習
  - StyleGAN
...
![GANの仕組みを示すイラスト（GeneratorとDiscriminatorの対立構造）](https://i.imgur.com/SVZB0Wi.png)
...
当時は[Chainerを使った機械学習](/2017/07/17/hinako-chainer/)の[Example](https://github.com/chainer/chainer/tree/master/examples/dcgan)を改造して学習から推論をやりましたがあまりうまくいきませんでした。
...
![StyleGANで生成された実在しない女性のポートレート画像](https://i.imgur.com/9mP8aH2.jpg)
...
![Progressive Growingの概念図（低解像度から高解像度へ段階的に画像を生成するプロセス）](https://i.imgur.com/bTE91Hx.png)
...
![Style Transferの例（写真に絵画の画風を適用した結果）](https://i.imgur.com/9EAE63P.png)
...
![AdaINのアーキテクチャ図（コンテンツとスタイルの統計量を用いた正規化プロセス）](https://i.imgur.com/z7ZpFko.png)
...
![StyleGANのGenerator構造図（constテンソル入力とAdaINによるStyle適用の流れ）](https://i.imgur.com/7xOURgl.png)
...
![gwern.netへの感謝を込めた肩たたき券のイラスト](https://i.imgur.com/0IEMnPa.png)
...
![StyleGANで生成されたアニメ風キャラクター画像](https://i.imgur.com/ET5Bn63.png)
...
![StyleGAN2のgenerate_anime.pyを実行するコマンドプロンプト画面](https://i.imgur.com/k3KihLx.png)

### まだうまく動かない

エラーがでました..。

![fused_bias_act.cuのコンパイルエラーが表示されたコマンドプロンプト](https://i.imgur.com/0KH7SgH.png)
...
![TensorFlowのGitHub IssueでVisual C++ 2015が必要と回答されている画面](https://i.imgur.com/zXCnrTq.png)
...
![StyleGAN2のREADMEにVisual Studio 2017対応と書かれている部分](https://i.imgur.com/1KUffz4.png)
...
![Visual Studio 2015をインストール後にgenerate_anime.pyを再実行する画面](https://i.imgur.com/YE8Pdyb.png)
...
![resultsディレクトリに生成されたアニメ画像ファイルの一覧](https://i.imgur.com/daSYwz2.png)

ちゃんとresultsに画像が出力されてます！

![StyleGAN2で生成された高品質なアニメ風キャラクター画像](https://i.imgur.com/VfRjfpW.png)
