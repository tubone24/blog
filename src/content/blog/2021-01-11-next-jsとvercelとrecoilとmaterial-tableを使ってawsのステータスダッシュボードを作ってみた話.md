...
description: "Next.jsとVercelを使ってAWS障害情報を見やすくするステータスダッシュボードを構築した記録。RecoilによるGlobal State管理、Material Tableでのデータ表示、Chart.jsでの障害可視化、Vercelへのデプロイ方法まで解説します。"
tags:
  - JavaScript
  - Next.js
  - Vercel
...
最近、これといった新しい技術に触れておらず、このままだとクビになりそうなので、そろそろ重い腰を上げてNext.jsを勉強することにしました。GraphQLを使った[GoでAWS Lambdaを動かした経験](/2019/11/26/go-lambda/)もあるので、AWSの知見を活かしていきます。
...
食わず嫌いでやらなかったNext.js+Recoilをやってみましたが、楽しく実装ができました。後日、[Hasura CloudのGraphQLとVercelの組み合わせ](/2021/07/27/hasura-graphql/)にも挑戦しています。
