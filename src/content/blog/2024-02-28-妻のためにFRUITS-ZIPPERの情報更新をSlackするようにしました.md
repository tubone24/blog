...
![FRUITS ZIPPER公式サイトのInformation欄のHTML要素構造を確認している画面](https://i.imgur.com/79xoiL5.png)
...
![SlackにFRUITS ZIPPERの更新情報が@channel通知で投稿された画面](https://i.imgur.com/92JtEWa.png)
...
![Notion Databaseに更新情報のタイトル・日付・リンク・チェックボックスが記録された画面](https://i.imgur.com/gPUDGkn.png)

Viewを変更することでカレンダー表示にもできます。（使い所はちょっとわからないですが。）

![Notion Databaseのカレンダービューでイベント日程を確認している画面](https://i.imgur.com/yoZJpIh.png)
...
![妻からSlack通知に対してよいフィードバックが返ってきた画面](https://i.imgur.com/vzyD8Iu.png)
