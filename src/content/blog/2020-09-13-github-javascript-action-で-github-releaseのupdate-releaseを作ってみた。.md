...
![GitHub ReleaseからDraft Releaseを作成する画面](https://i.imgur.com/5715wbc.png)

うまく公開できると、こんな漢字で、usesで使えるActionとして公開されます。

![GitHub MarketplaceにUpdate GitHub Releaseが公開された画面](https://i.imgur.com/kXVhSw7.png)
...
![ビッグウェーブに乗るサーファーのイメージ画像](https://i.imgur.com/rp2VEVO.jpg)
