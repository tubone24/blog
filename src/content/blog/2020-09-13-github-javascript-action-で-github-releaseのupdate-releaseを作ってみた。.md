...
description: "GitHub JavaScript ActionをTypeScriptで自作し、GitHub ReleaseのUpdate Release機能を実装する方法を解説。action.ymlの設定、tsc＋nccによるバンドル、@actions/core・@actions/githubの使い方、マーケットプレイスへの公開手順を紹介します。"
tags:
  - GitHub
  - GitHub Actions
headerImage: /images/blog/kXVhSw7.png
templateKey: blog-post
---
ちょうどいい、**GitHub Actions**がなかったので作ってみました。以前[GitHub Actionを使った簡単CI](/2019/09/02/github-action/)の記事も書きましたが、今回はAction自体を自作します。
...
![GitHub ReleaseからDraft Releaseを作成する画面](/images/blog/5715wbc.png)

うまく公開できると、こんな漢字で、usesで使えるActionとして公開されます。

![GitHub MarketplaceにUpdate GitHub Releaseが公開された画面](/images/blog/kXVhSw7.png)
...
GitHub Actionsが徐々に使われるようになってきましたのでビッグウェーブに乗りたいですね。実際に、このUpdate Releaseは[Nim用のTwitterSDK開発](/2020/09/22/nim-twitter/)のCI/CDでも活用しています。

![ビッグウェーブに乗るサーファーのイメージ画像](/images/blog/rp2VEVO.jpg)
