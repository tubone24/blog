...
description: "iTerm2+tmuxからRust製ターミナルWezTermへの移行体験記です。SSH接続やタブカスタマイズ、右ステータスバーなどのLuaによる設定例を紹介し、GPUアクセラレータやクロスプラットフォーム対応の使い心地を解説します。"
tags:
  - terminal
  - 開発環境
headerImage: /images/blog/h5RiIEv.png
...
![iTerm2+tmuxで構築した従来のターミナル環境のスクリーンショット](/images/blog/WeeoXsW.png)
...
![WezTermに移行した後のターミナル画面のスクリーンショット](/images/blog/h5RiIEv.png)
...
![プロセスごとにアイコンが変わるWezTermのカスタマイズされたタブ表示](/images/blog/NOGpKZf.png)
...
あと、個人的にマストかなと思うのがvisual_bellです。Macの音声をmuteにしているときにも警告が可視化できたほうがいいと考えているからです。
...
久しぶりに開発環境を更新しましたが楽しかったです。[デスクトップ周り](/2022/03/20/desktop/)の記事でも紹介している環境と合わせて、より快適な開発ライフを目指していきたいですね。[使用機材一覧](/2019/02/13/my-gear/)にも他の環境情報をまとめてあります。
