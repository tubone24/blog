...
![iTerm2+tmuxで構築した従来のターミナル環境のスクリーンショット](https://i.imgur.com/WeeoXsW.png)
...
![WezTermに移行した後のターミナル画面のスクリーンショット](https://i.imgur.com/h5RiIEv.png)
...
![プロセスごとにアイコンが変わるWezTermのカスタマイズされたタブ表示](https://i.imgur.com/NOGpKZf.png)
