...
![MetasploitableのZIPを展開して表示されるVMDKファイル](https://i.imgur.com/Hx7m0bS.png)
...
![Microsoft Virtual Machine ConverterのMSIインストーラー画面](https://i.imgur.com/qi0xtKd.png)
...
![PowerShellを管理者モードで起動した画面](https://i.imgur.com/EIowtzV.png)
...
![Hyper-vの仮想マシン作成画面で既存の仮想ハードディスクを選択する画面](https://i.imgur.com/n7h7LsX.png)
...
![MetasploitableがHyper-v上で無事起動した画面](https://i.imgur.com/oV13syg.png)
