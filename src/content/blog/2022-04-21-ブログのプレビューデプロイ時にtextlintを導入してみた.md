...
description: "技術ブログの表記揺れや日本語の誤りを自動検出するtextlintの導入手順を解説します。SmartHRプリセットの活用法やreviewdogと連携したGitHub ActionsでのCI自動校正パイプラインの構築方法も紹介します。"
tags:
  - textlint
  - GithubActions
headerImage: /images/blog/ZRXcbaO.png
...
このブログは[TypeScript製](/2023/01/01/this-blog/)なのでnpmでtextlintを入れてしまえば良さそうです。
...
![PRのレビューコメントとしてtextlintの校正結果が表示されたGitHub画面](/images/blog/ZRXcbaO.png)
...
textlintを使って良いブログライフを！CIの品質向上といえば、[depcheckをGitHub Actionで使いPRコメントに結果を出力させる](/2021/11/21/depcheck/)のも依存管理の改善におすすめです。
