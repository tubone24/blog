...
![Netlifyのダッシュボードに表示されるビルド時間の残り分数](https://i.imgur.com/TSm24w0.png)
...
![工務店のCMをイメージしたおじさんのイラスト](https://i.imgur.com/JlvUJ4zl.png)
...
![NetlifyのAsset optimization設定を無効化する画面](https://i.imgur.com/ytjbJQA.png)

![NetlifyのForm detection設定を無効化する画面](https://i.imgur.com/LfL70Br.png)
...
![Getform.ioのデフォルトThankYouページ](https://i.imgur.com/sT5vhFE.png)
...
![自作のThanksページが表示されたフォーム送信完了画面](https://i.imgur.com/gumRkbF.png)
...
![Netlifyのビルド時間が0分になったダッシュボード画面](https://i.imgur.com/ugdUr9l.png)
