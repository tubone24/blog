...
description: "Netlify Formを使ってGatsby.js製の静的サイトにお問い合わせフォームを実装する方法を解説。data-netlify属性の設定、スパムBot対策のhoneypot設定、フォーム送信通知の確認手順まで、コード付きで紹介します。"
tags:
  - JavaScript
  - Netlify
  - Netlify Form
  ...
  - React
  - Contact Form
headerImage: '/images/blog/uWmwQRq.png'
...
せっかく[Gatsby.jsで作ったブログ](/2019/09/01/netlify-and-gatsby/)で静的サイトに仕上げてるのでPHPで書くのだけはやめたいです。
...
![Netlify管理画面のForms Activity画面でフォーム送信内容を確認する様子](/images/blog/uWmwQRq.png)

また、Formが送信されたときにメールor Slack or Webhookを流す機能もあります。

![Netlifyのフォーム送信通知設定画面（メール・Slack・Webhook選択）](/images/blog/BnS7iSC.png)

これでお問い合わせを見逃すことがなくなりますね！

## 結論

以前、PHPで頑張ってFormを作ってましたが、最近はこんなに簡単にFormが作れるのかと感心しました。なお、後日[React Hook FormとGetform.ioを使ったフォーム実装](/2021/03/07/react-hook-form/)にも挑戦しています。
