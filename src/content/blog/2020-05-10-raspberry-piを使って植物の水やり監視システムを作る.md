...
tags:
  - 電子工作
  - Raspberry PI
headerImage: /images/blog/amaoydT.jpg
...
![窓際に置いた観葉植物ガジュマルの写真](/images/blog/mDq4FWO.jpg)
...
![Raspberry Pi Zero WHのパッケージ内容（本体・ヒートシンク等）](/images/blog/GmYDK0C.jpg)
...
![ヒートシンクを取り付けたRaspberry Pi Zero WHの基板アップ](/images/blog/k4R1znI.jpg)
...
![土壌水分検出センサーモジュールの外観写真](/images/blog/amaoydT.jpg)
...
![DHT11温湿度センサーモジュールの外観写真](/images/blog/JvjiUuD.jpg)

## フォトレジスタ

フォトレジスタとは光が当たると抵抗が下がるやつです。

![フォトレジスタ（光依存抵抗器）の外観写真](/images/blog/kSjQyey.jpg)
...
![ADC0832を搭載したブレッドボード上の回路写真](/images/blog/msMkGJb.jpg)
...
![センサー回路の配線図（土壌センサー・フォトレジスタ・DHT11とADC0832の接続構成）](/images/blog/bwjrBtF.png)

![実際に配線したブレッドボードとRaspberry Pi Zeroの全体写真](/images/blog/TwBitlX.jpg)
...
![ガジュマルの植木鉢に土壌センサーとRaspberry Pi Zeroを設置した様子](/images/blog/2J8rx9K.jpg)

Zabbixのexternal scriptsを使ってAPIから情報を取得し、グラフにしてみました。[netatmoのセンシング](/2019/10/13/typhoon/)と組み合わせると室内環境の監視がより充実します。

![Zabbixで土壌水分・温度・湿度・照度のセンサーデータをグラフ表示した画面](/images/blog/tHoBvbQ.png)
