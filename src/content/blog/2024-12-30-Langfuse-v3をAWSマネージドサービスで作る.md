...
![Langfuse画面上部にBackground Migrationsのステータスを示す緑色バッジが表示されている](https://i.imgur.com/j7YZLwB.png)
...
![Background Migrationsの進捗状況画面で各マイグレーションのステータスが一覧表示されている](https://i.imgur.com/NlPszng.png)
...
![PostgreSQLのbackground_migrationsテーブルでstatusがSuccess/Activeのレコード一覧](https://i.imgur.com/9RD4od5.png)
...
![SQLでstatusをFailedに変更した後のbackground_migrationsテーブル](https://i.imgur.com/sHiLXMC.png)

すると、**retryボタンが押せる**ようになり、再度マイグレーションを実行できます。

![Background MigrationsのUI上でRetryボタンが押せるようになった画面](https://i.imgur.com/TG6QTAq.png)
