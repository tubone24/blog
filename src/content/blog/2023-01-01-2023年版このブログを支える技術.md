...
![2023年の干支であるうさぎのイラスト](https://i.imgur.com/cRHAJbol.png)
...
![チェンソーマンの未来の悪魔が「最高」と叫ぶシーン](https://i.imgur.com/Cv8jtrol.jpg)
...
![tw-del-backupで復元したPreact導入時のバンドルサイズ削減報告ツイート](https://i.imgur.com/Pb4nL6Ql.png)
...
![webpack-bundle-analyzerによるProduction環境のバンドルサイズ可視化結果](https://i.imgur.com/ssbwpVol.png)
...
![Algoliaを使ったブログ内検索のSearchboxコンポーネントの動作デモ](https://i.imgur.com/uebtAld.gif)
...
![Lighthouseでアクセシビリティ100点を達成したスコア画面](https://i.imgur.com/gXIfewW.png)
...
![Sentryダッシュボードに表示されたブログのエラー一覧](https://i.imgur.com/IOVq3ls.png)

あと、**パフォーマンスメトリック**も取っているのでパフォーマンス改善への意欲づくりに貢献してます！意欲だけあって実行しないですが。

![Sentryのパフォーマンスメトリック画面でWebVitalsのスコアを表示](https://i.imgur.com/GSaWx2D.png)
...
![GTmetrixでグレードAを取得したブログのパフォーマンス計測結果](https://i.imgur.com/whYjszk.png)

Performance metricもおおむね良さそうです。

![GTmetrixのPerformance Metricsで各指標がグリーン判定を示した結果](https://i.imgur.com/y7N1fDH.png)

ただ、Lighthouse([Page Insight](https://pagespeed.web.dev))で測ってみるとデスクトップはまずまずですが、**モバイルの結果がすこぶる悪い**です。

![Lighthouseのデスクトップ版スコアで高得点を示した結果](https://i.imgur.com/zQ0pt29.png)

![Lighthouseのモバイル版スコアでパフォーマンスが低く出た結果](https://i.imgur.com/TEMPeDd.png)
...
![Google Analytics 4のSearch Console Insightで表示された流入検索ワードランキング](https://i.imgur.com/32aZAir.png)
