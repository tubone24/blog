...
![ChromeDriverのバージョン不一致エラーメッセージ：session not createdが表示されている](https://i.imgur.com/6WFqOEs.png)
...
![DockerHubの個人レポジトリ作成画面：公開設定をpublicに設定](https://i.imgur.com/8xlE18N.png)
...
では、 ![CircleCIのリラン実行ボタン](https://i.imgur.com/w7LQ34r.png) しましょう！
...
![CircleCIのビルド失敗画面：Chrome Beta変更後もテストが通らなかった結果](https://i.imgur.com/p2WKJeV.png)
