...
description: "CircleCIでChromeDriver v76非対応エラーが発生した際のトラブルシューティング記録。DockerイメージのChrome Betaへの差し替えやバージョン固定など、E2Eテスト環境のChrome互換性問題への対処法を試行錯誤した過程をまとめました。"
tags:
  - 自動テスト
  - E2E Test
  - Selenium
  - GoogleChrome
  - ChromeDriver
headerImage: '/images/blog/6WFqOEs.png'
templateKey: blog-post
---

Vue.jsで書いているコードのCI(CircleCI)が通らなくなっていろいろ調べていると原因がわかってきました。結論としてはこの記事では解決できておらず、[Nightwatch.jsでE2Eテストを回したときにうまく動かないたった一つの理由](/2019/09/10/nightwatchjs-chromedriver/)で解決しています。
...
![ChromeDriverのバージョン不一致エラーメッセージ：session not createdが表示されている](/images/blog/6WFqOEs.png)
...
![DockerHubの個人レポジトリ作成画面：公開設定をpublicに設定](/images/blog/8xlE18N.png)
...
では、 ![CircleCIのリラン実行ボタン](/images/blog/w7LQ34r.png) しましょう！

## 結果

ダメ見たいですね・・

ここまでやったのに解決しない。原因はNightwatch.jsにありました。詳しくは[続編の記事](/2019/09/10/nightwatchjs-chromedriver/)をご覧ください。

![CircleCIのビルド失敗画面：Chrome Beta変更後もテストが通らなかった結果](/images/blog/p2WKJeV.png)
