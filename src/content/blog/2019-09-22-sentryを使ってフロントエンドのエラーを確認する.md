...
tags:
  ...
  - Vue.js
  - 監視
headerImage: '/images/blog/sN5BJB0.png'
...
![Sentryの公式サイトトップ画面：エラーイベントの収集・解析サービスの概要](/images/blog/7dWvynP.png)
...
![ブラウザのF12開発者ツールで404NotFoundエラーが出ている画面](/images/blog/BUHjgkf.png)

Sentryに早速エラーが通知されます。

エラーが発火したコード位置もわかります。

![Sentryのエラー詳細画面：エラーが発火したコード位置が表示されている](/images/blog/Sss0JTL.png)

SlackにIntegrationすれば通知もリアルタイムできます。

![SentryからSlackへのエラー通知メッセージ](/images/blog/qQSiDrc.png)

出てきたエラーはIssuesとしてまとめられます。

有料版ではカテゴライズもされるようですが、お金がないので無料版です。

![SentryのIssues一覧画面：収集されたエラーがまとめて表示されている](/images/blog/IoLPNNW.png)
