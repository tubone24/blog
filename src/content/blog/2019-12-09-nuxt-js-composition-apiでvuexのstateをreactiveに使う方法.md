...
![ebook-homebrewのOpenAPIリファレンス画面](https://i.imgur.com/9OhZRsB.png "利用するAPIリファレンス")
...
![StateがReactiveでないためServerStatusが更新されない画面](https://i.imgur.com/xihsCyz.png)
...
![ReactiveなVuexストアで正しくServerStatusが表示された画面](https://i.imgur.com/BWyjwja.png)
