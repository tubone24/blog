...
tags:
  ...
  - 分類学習
  - 顔認識
headerImage: '/images/blog/1tudTrI.png'
...
![ひなこのーとのキャラクター一覧画像](/images/blog/dIY5jEJ.jpg)

### ごちうさ

![ごちうさのキャラクター一覧画像](/images/blog/E6l9miS.jpg)
...
![OpenCVで切り抜いた50x50のキャラクター顔画像データセット](/images/blog/qfwNwpQ.png)
...
![ひなこのーとアニメ画像にキャラクター分類結果を重ねた認識結果](/images/blog/1tudTrI.png)
...
![ごちうさの画像をひなこのーとモデルで分類した結果](/images/blog/N909ILj.png)
...
![きんモザとごちうさのコラボ画像での分類結果その1](/images/blog/mWRGXtm.png)

![きんモザとごちうさのコラボ画像での分類結果その2](/images/blog/KLiwNQR.png)
...
![絵のタッチを変えたごちうさ画像での分類結果](/images/blog/GwUtdtM.png)

<span style="font-size: 200%">ココア、お前だったのか!!（結論）</span>

### おまけ１　ひなこのーともイラストで認識させてみる

![ひなこのーとイラストでのキャラクター認識結果その1](/images/blog/85nBHnf.png)

![ひなこのーとイラストでのキャラクター認識結果その2](/images/blog/YQrn166.png)

どうやら、くいなちゃんの認識率が一番いい。くいなちゃんかわいいからね。

### おまけ２ くいなちゃん、某オタク少女に似ている説を確かめる

![くいなちゃんと某オタク少女キャラの比較認識結果](/images/blog/DCkFvv2.png)
