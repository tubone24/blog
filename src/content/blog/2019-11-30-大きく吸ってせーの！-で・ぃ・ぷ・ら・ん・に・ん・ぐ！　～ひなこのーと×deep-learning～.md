...
description: "PythonとChainerのCNNを使い、アニメ「ひなこのーと」のキャラクター分類モデルを構築。OpenCVでアニメ顔を検出し、約9000枚の画像で学習させた結果や、ごちうさキャラとの比較実験の結果を紹介する、Deep Learning×アニメの実践記事です。"
tags:
  - Python
  - Chainer
  - ひなこのーと
...
![ひなこのーとのキャラクター一覧画像](https://i.imgur.com/dIY5jEJ.jpg)

### ごちうさ

![ごちうさのキャラクター一覧画像](https://i.imgur.com/E6l9miS.jpg)
...
![OpenCVで切り抜いた50x50のキャラクター顔画像データセット](https://i.imgur.com/qfwNwpQ.png)

### 学習させる

ご注文はDeep Learningですか？は、Caffeを使っていますが、自分はChainerの方がなじみあるので、Chainerを使っていきます。（Chainerを使ったもう1つの取り組みとして、[LSTMでおしゃべりBotを作った記事](/2017/06/04/chainer-chieri-bot/)もあります。）
...
![ひなこのーとアニメ画像にキャラクター分類結果を重ねた認識結果](https://i.imgur.com/1tudTrI.png)
...
![ごちうさの画像をひなこのーとモデルで分類した結果](https://i.imgur.com/N909ILj.png)
...
![きんモザとごちうさのコラボ画像での分類結果その1](https://i.imgur.com/mWRGXtm.png)

![きんモザとごちうさのコラボ画像での分類結果その2](https://i.imgur.com/KLiwNQR.png)
...
![絵のタッチを変えたごちうさ画像での分類結果](https://i.imgur.com/GwUtdtM.png)

<span style="font-size: 200%">ココア、お前だったのか!!（結論）</span>

### おまけ１　ひなこのーともイラストで認識させてみる

![ひなこのーとイラストでのキャラクター認識結果その1](https://i.imgur.com/85nBHnf.png)

![ひなこのーとイラストでのキャラクター認識結果その2](https://i.imgur.com/YQrn166.png)

どうやら、くいなちゃんの認識率が一番いい。くいなちゃんかわいいからね。

### おまけ２ くいなちゃん、某オタク少女に似ている説を確かめる

![くいなちゃんと某オタク少女キャラの比較認識結果](https://i.imgur.com/DCkFvv2.png)

大丈夫でした!!!

機械学習をもっと深く知りたい方は、[StyleGANとStyleGAN2を使った美少女キャラ生成の記事](/2020/05/03/stylegan2-anime/)もおすすめです。
