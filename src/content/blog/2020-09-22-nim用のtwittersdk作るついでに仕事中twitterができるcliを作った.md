...
tags:
  - Nim
  - Twitter
headerImage: /images/blog/BO7QR6p.png
...
![Nim言語の公式ロゴ](/images/blog/BbHTNwQ.png)
...
![oAuth1.0の認証フロー図：RequestToken取得からAccessToken取得までの流れ](/images/blog/KrG6jYE.png)
(https://oauth.net/core/1.0/)
...
![Exponential BackOffの計算式](/images/blog/lFclC4Z.png)
...
![No Twitter No Lifeのイメージ画像](/images/blog/h8XZ9d2.jpg)
...
![GitHub ReleaseにWindows・Mac・Ubuntuの各バイナリがアップロードされた画面](/images/blog/zhLloGo.png)

## できたかも～

ということで..。

![CLIツールが完成して喜ぶイメージ](/images/blog/tMjBX5q.jpg)
...
![Twitter OAuth認証画面でPINコードが表示されている画面](/images/blog/3GwsdvT.png)

という具合でPINが出てくるのでこちらを入力してくれればアクセストークンを取ってそのままタイムラインの表示に移ります。

![CLI上でTwitterのタイムラインが色付きで表示されている画面](/images/blog/VASzn6U.png)
...
![post_twitter_on_workでCLI上からTwitterを操作するデモ動画](/images/blog/zAFRZJQ.gif)
