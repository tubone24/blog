...
description: "npmパッケージcolors.jsの作者が意図的に悪意あるコードを仕込み、CIが停止した事象の原因調査と対処法を解説します。package.jsonのresolutionsによる回復手順やOSSサプライチェーンセキュリティについても考察します。"
tags:
  - color.js
  - oss
headerImage: /images/blog/QjbL6ih.png
...
@babel/coreのバージョンアップで[CI](/2019/09/02/github-action)を動かしていたところ謎のアスキーアート的なログが出たままヒープメモリを食いつぶして落ちてしまう事象が昨日の夜中に発生しました。

<https://github.com/tubone24/portfolio/runs/4755929687?check_suite_focus=true>

![CIログに表示された星条旗のアスキーアートとヒープメモリ超過エラー](/images/blog/QjbL6ih.png)
...
![ローカル環境でcolors.jsの無限ループが発生しMacのファンが回る様子](/images/blog/d6EyJpJ.gif)
...
これからもOSSが発展するように自分にできることは何か模索していきたいと思います。ちなみに依存パッケージの管理には[Renovate](/2022/04/25/renovate-error/)のようなツールも活用しつつ、定期的にサプライチェーンの安全性を確認することが重要ですね。
