...
description: "Gatsby.jsのブログにEstimated Reading Time（読了時間）を実装する方法を解説。gatsby-remark-reading-timeプラグインの導入手順に加え、滞在時間が13.8%向上したBrian Crayの実験結果など、読了時間表示の歴史と効果も紹介します"
tags:
  - JavaScript
  - Gatsby.js
  - Estimated Reading Time
  - あと何分
headerImage: '/images/blog/rYZdFYX.png'
...
![Webページの文字数と実際に読まれる割合の関係を示したグラフ](https://media.nngroup.com/media/editor/alertbox/percent-of-text-read.gif)
...
このブログは**Gatsby.js**でできていますが（[ブログの構築についてはこちら](/2019/09/01/netlify-and-gatsby/)）、Gatsby.jsで利用する**GraphQL**にwordcountとEstimated Reading Timeを追加するプラグイン**gatsby-remark-reading-time**があるのでインストールします。
...
![Gatsby.jsブログに実装した読了時間表示の完成画面](/images/blog/rYZdFYX.png)

こんな感じで無事実装できました。(CSSは別で当ててます)

## 結論

そもそも読み終わるまで〇〇分の歴史から追いかけると面白いですね。無事できてよかったです。ブログのカスタマイズは他にも[投稿をGitHubの草として表示する機能](/2020/1/5/github-heatmap-blog/)なども実装しています。
