...
tags:
  ...
  - Jetson nano
  - SainSmart IMX219
headerImage: /images/blog/lPOtTYa.png
...
![Jetson Nanoのインターフェース図でカメラモジュールコネクタの位置を示す](/images/blog/xrDd4y5.png)

⑨がモジュールのコネクタとなります。

![ケースに入れたJetson NanoにMIPI CSI-2カメラモジュールを接続した状態](/images/blog/AZAkt7z.jpg)
...
![SainSmart IMX219カメラモジュールの外観写真](/images/blog/gWqd2xb.jpg)
...
![UGATITで自撮り画像がアニメ風キャラクターに変換された結果の画面](/images/blog/lPOtTYa.png)

ちょっともたつきますが、ちゃんとリアルタイムに処理しているようです。[StyleGAN2でアニメキャラを生成する](/2020/05/03/stylegan2-anime/)のもおすすめです。

![UGATITによるリアルタイムアニメ風変換の動作GIF](/images/blog/pFHv6zC.gif)