...
description: "Gatsby.jsブログにReact Calendar Heatmapを導入し、記事の投稿日をGitHub風の草（ヒートマップ）として表示する方法を解説。StaticQueryでGraphQLからデータを取得し、ツールチップやクリック遷移も実装する手順を紹介します"
tags:
  - JavaScript
  - Gatsby.js
  - React
...
このブログは[**Gatsby.js**というフレームワークで構築](/2019/09/01/netlify-and-gatsby/)しているので要素技術は**React**なのでReactでGitHubのHeat mapを作る方法を探していきます。
...
今年もかっこいいWeb勉強していきたいですね。よろしくお願いします。Gatsby.jsのカスタマイズとしては、[読了時間表示の追加](/2019/12/20/readingtime/)にも取り組んでいます。また、GitHubの草に関しては[90日間草を生やし続けた感想](/2019/11/25/github/)もぜひどうぞ。
