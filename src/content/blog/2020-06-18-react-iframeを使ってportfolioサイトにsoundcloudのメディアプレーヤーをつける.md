...
![Gatsby.jsで作ったPortfolioサイトのトップページ画面](https://i.imgur.com/YklaEFu.png)
...
![SoundCloudのShareボタンからiframeコードを取得する画面](https://i.imgur.com/qoLj5Cq.png)
...
![PortfolioサイトにSoundCloudメディアプレーヤーが埋め込まれた完成画面](https://i.imgur.com/Btf7On2.png)
