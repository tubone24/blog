...
description: "余ったRaspberry Piと2.7インチ電子ペーパーでGoogleカレンダー連携の万年カレンダーを自作。oAuth2.0認証の詰まりポイントやGPIOキースイッチによる4画面切り替え実装など、小型ディスプレイ活用のノウハウを紹介します。"
tags:
  - RaspberryPi
  - 電子ペーパー
  - Googleカレンダー
...
ラズパイと電子ペーパーのセットアップは過去記事[MQTTと電子ペーパーを使って年賀状を作る](/2021/01/01/mqtt-nenga/)で実施済みなのでこちらを使うことにします。
...
![2.7インチ電子ペーパーに表示したカレンダーが小さすぎる様子](https://i.imgur.com/d4TGMVSl.jpg)

小さいっ！圧倒的に小さい。Zippoと比べてもらうとわかるのですが、こんなの使いものにならない！

![Zippoと比較した電子ペーパーカレンダーのサイズ感](https://i.imgur.com/tERPWfnl.jpg)
...
![電子ペーパーに表示されたGoogleカレンダーの予定表](https://i.imgur.com/mtf5J9v.jpg)
...
![Waveshare 2.7インチ電子ペーパーHATの4つのキースイッチ](https://i.imgur.com/6L3j6pFl.jpg)
...
![電子ペーパーに表示した当月カレンダー画面](https://i.imgur.com/3HqmDpil.jpg)

翌月カレンダー↓

![電子ペーパーに表示した翌月カレンダー画面](https://i.imgur.com/pa1jUtbl.jpg)

当月カレンダー&前月・来月カレンダー↓

![電子ペーパーに表示した当月・前月・来月カレンダー一覧画面](https://i.imgur.com/QR3FGt8l.jpg)

予定表↓

![電子ペーパーに表示したGoogleカレンダーの予定表画面](https://i.imgur.com/M6muDFQl.jpg)

電子ペーパーの再描画はかなり重たいので切り替えには時間がかかるのが欠点ですが他はまぁまぁ上出来ではないでしょうか？同じくラズパイを活用した[監視カメラシステム](/2021/07/21/motion-ir/)や[植物の水やり監視](/2020/05/10/plant-check/)もぜひ参考にしてみてください。
