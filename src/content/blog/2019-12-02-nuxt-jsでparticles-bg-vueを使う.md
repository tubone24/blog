...
![Nuxt.jsにparticles-bg-vueを適用した実際の画面](https://i.imgur.com/IAstOlF.png)
...
![ブラウザ拡大時にparticleのcanvasがはみ出る問題の様子](https://i.imgur.com/FhOet7R.png)
...
![開発者ツールでparticleのcanvasタグを確認している様子](https://i.imgur.com/hw6bydF.png)
...
![canvasObjectでstyleを変更した後のElements確認](https://i.imgur.com/ct8mkR2.png)

正しくstyleが変更され、

![canvasObjectでheightを120%に設定し拡大時もはみ出なくなった画面](https://i.imgur.com/0rTlW56.png)
