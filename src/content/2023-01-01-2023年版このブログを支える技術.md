...
ここらへんはCI/CD編でまた語ろうかと思うのですが、現在はNetlifyのBuild機能は使っておらず、BuildはGitHub Actionsで実施して、Build済みのバンドルファイル一式を[Netlify CLI](https://docs.netlify.com/cli/get-started/)でDeployする形式を採用してます。
