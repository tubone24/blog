...
type PeriodQueryQuery = { readonly allMarkdownRemark: { readonly totalCount: number, readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly frontmatter: { readonly id: string | null, readonly title: string | null, readonly date: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly headerImage: string | null, readonly description: string | null, readonly url: string | null, readonly yyyymmdd: string | null } | null } }> } };

type SidebarQueryQueryVariables = Exact<{ [key: string]: never; }>;


type SidebarQueryQuery = { readonly all: { readonly totalCount: number, readonly allPosts: ReadonlyArray<{ readonly node: { readonly frontmatter: { readonly date: string | null, readonly tags: ReadonlyArray<string | null> | null } | null } }> }, readonly limited: { readonly latestPosts: ReadonlyArray<{ readonly node: { readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null, readonly date: string | null, readonly url: string | null } | null } }> } };

type getAllPagesQueryVariables = Exact<{ [key: string]: never; }>;


type getAllPagesQuery = { readonly allSitePage: { readonly edges: ReadonlyArray<{ readonly node: { readonly path: string } }> } };

type getAllTagsQueryVariables = Exact<{ [key: string]: never; }>;


type getAllTagsQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: { readonly tags: ReadonlyArray<string | null> | null } | null } }> } };
...
type tagQueryQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly frontmatter: { readonly id: string | null, readonly title: string | null, readonly date: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly headerImage: string | null, readonly description: string | null, readonly url: string | null } | null } }> } };
