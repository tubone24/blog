...
declare namespace GatsbyTypes {
  ...
  type MarkdownRemarkFrontmatterFilterInput = {
    ...
    readonly headerImage: Maybe<StringQueryOperatorInput>;
  ...
  type SidebarQueryQuery = {
    readonly all: Pick<MarkdownRemarkConnection, "totalCount"> & {
      readonly allPosts: ReadonlyArray<{
        readonly node: {
          readonly frontmatter: Maybe<
            Pick<MarkdownRemarkFrontmatter, "date" | "tags">
          >;
        };
      }>;
    };
    readonly limited: {
      readonly latestPosts: ReadonlyArray<{ readonly node: cardDataFragment }>;
    };
  };
  ...
  type getAllPagesQuery = {
    readonly allSitePage: {
      readonly edges: ReadonlyArray<{ readonly node: Pick<SitePage, "path"> }>;
    };
  };
  ...
  type getAllTagsQuery = {
    readonly allMarkdownRemark: {
      readonly edges: ReadonlyArray<{
        readonly node: {
          readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, "tags">>;
        };
      }>;
    };
  };
  ...
  type postFragment = {
    ...
    readonly frontmatter: Maybe<
      Pick<
        MarkdownRemarkFrontmatter,
        "id" | "title" | "slug" | "date" | "headerImage" | "tags"
      >
    >;
  };
  ...
  type BlogPostQueryQuery = {
    readonly content: {
      readonly edges: ReadonlyArray<{
        readonly node: Pick<MarkdownRemark, "id" | "excerpt"> & postFragment;
      }>;
    };
  };
  ...
  type PeriodQueryQuery = {
    readonly allMarkdownRemark: Pick<MarkdownRemarkConnection, "totalCount"> & {
      readonly edges: ReadonlyArray<{
        readonly node: Pick<MarkdownRemark, "id"> & {
          readonly frontmatter: Maybe<
            Pick<
              MarkdownRemarkFrontmatter,
              "id" | "title" | "date" | "tags" | "headerImage" | "description"
            > & {
              url: MarkdownRemarkFrontmatter["slug"];
              yyyymmdd: MarkdownRemarkFrontmatter["date"];
            }
          >;
        };
      }>;
