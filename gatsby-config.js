        ...
        feeds: [
          {
            ...
            serialize: ({ query: { site, allMarkdownRemark } }) => allMarkdownRemark.edges.map((edge) => ({
              ...
              title: edge.node.frontmatter.title.replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/\s/g, '&nbsp;').replace(/&/g, '&amp;').replace(/"/g, '&quot;').replace(/'/g, '&#39;'),
              description: edge.node.excerpt.replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/\s/g, '&nbsp;').replace(/&/g, '&amp;').replace(/"/g, '&quot;').replace(/'/g, '&#39;'),
