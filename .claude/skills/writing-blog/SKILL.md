...
3. 参考文献やリンクを追加し、情報の信頼性を高める。（Web Searchやfetchツールを使って最新情報を確認すること、存在しない技術キーワードや参考文献のないものは必ずユーザーに確認すること）
...
9. 最終的な記事をユーザーに提出し、フィードバックを求める。
10. 必要に応じて修正を行い、最終版を完成させる。
