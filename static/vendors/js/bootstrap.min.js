...
!(function (t, e) { typeof exports === 'object' && typeof module !== 'undefined' ? e(exports, require('jquery'), require('popper.js')) : typeof define === 'function' && define.amd ? define(['exports', 'jquery', 'popper.js'], e) : e(t.bootstrap = {}, t.jQuery, t.Popper); }(this, (t, e, n) => {
  function i(t, e) { for (let n = 0; n < e.length; n++) { const i = e[n]; i.enumerable = i.enumerable || !1, i.configurable = !0, 'value' in i && (i.writable = !0), Object.defineProperty(t, i.key, i); } } function s(t, e, n) { return e && i(t.prototype, e), n && i(t, n), t; } function r() { return (r = Object.assign || function (t) { for (let e = 1; e < arguments.length; e++) { const n = arguments[e]; for (const i in n)Object.prototype.hasOwnProperty.call(n, i) && (t[i] = n[i]); } return t; }).apply(this, arguments); }e = e && e.hasOwnProperty('default') ? e.default : e, n = n && n.hasOwnProperty('default') ? n.default : n; let o; let a; let l; let h; let c; let u; let f; let d; let _; let g; let p; let m; let v; let E; let T; let y; let C; let I; let A; let b; let D; let S; let w; let N; let O; let k; const P = (function (t) {
    ...
    const e = 'carousel'; const n = 'bs.carousel'; const i = `.${n}`; const o = t.fn[e]; const a = {
      ...
      }, o._jQueryInterface = function (e) { return this.each(function () { let i = t(this).data(n); let s = { ...a, ...t(this).data() }; typeof e === 'object' && (s = { ...s, ...e }); const l = typeof e === 'string' ? e : s.slide; if (i || (i = new o(this, s), t(this).data(n, i)), typeof e === 'number')i.to(e); else if (typeof l === 'string') { if (typeof i[l] === 'undefined') throw new TypeError(`No method named "${l}"`); i[l](); } else s.interval && (i.pause(), i.cycle()); }); }, o._dataApiClickHandler = function (e) { const i = P.getSelectorFromElement(this); if (i) { const s = t(i)[0]; if (s && t(s).hasClass(_)) { const a = { ...t(s).data(), ...t(this).data() }; const l = this.getAttribute('data-slide-to'); l && (a.interval = !1), o._jQueryInterface.call(t(s), a), l && t(s).data(n).to(l), e.preventDefault(); } } }, s(o, null, [{ key: 'VERSION', get() { return '4.0.0'; } }, { key: 'Default', get() { return a; } }]), o;
    ...
    const e = 'popover'; const n = 'bs.popover'; const i = `.${n}`; const o = t.fn[e]; const a = new RegExp('(^|\\s)bs-popover\\S+', 'g'); const l = {
      ...U.Default, placement: 'right', trigger: 'click', content: '', template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>',
    }; const h = { ...U.DefaultType, content: '(string|element|function)' }; const c = 'fade'; const u = 'show'; const f = '.popover-header'; const d = '.popover-body'; const _ = {
